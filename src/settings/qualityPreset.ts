...
export type QualityPreset = "default" | "eco" | "2k" | "4k" | "maximum" | "custom";
...
export const QUALITY_PRESETS: Record<Exclude<QualityPreset, "custom">, QualityPresetSettings> = {
  ...
  eco: { renderResolution: "720p", modelResolution: "2k", fpsLimit: 30 },
...
export function isQualityPreset(value: unknown): value is QualityPreset {
  return value === "default" || value === "eco" || value === "2k" || value === "4k" || value === "maximum" || value === "custom";
}
